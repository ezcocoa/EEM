...
(ecb-layout-define "right8" right
  "This function creates the following layout:
...
(ecb-layout-define "mds-left" left
  "This function creates the following layout:
...
(ecb-layout-define "mdsh-left" left
  "This function creates the following layout:
...
(ecb-layout-define "mds-right" right
  "This function creates the following layout:
...
(ecb-layout-define "mdsh-right" right
  "This function creates the following layout:
...
(ecb-layout-define "a-right" right
  "This function creates the following layout:
...
;; Layout mds-left-a-right -----------------------------------------------------

(ecb-layout-define "mds-left-a-right" left-right
  "This function creates the following layout:
...
;; Layout mds-right-a-left -----------------------------------------------------

(ecb-layout-define "mds-right-a-left" left-right
  "This function creates the following layout:
...
little more place."
  ...
  (ecb-split-ver 0.5)
  (ecb-set-sources-buffer)
  (select-window (previous-window (previous-window (previous-window (selected-window) 0) 0) 0)))
